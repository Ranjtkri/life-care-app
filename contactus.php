...
$tomail = $_POST['email'];
	...
	sendmail("shivame2011@gmail.com","Mail from Appoint My Doctor",$message);
...
<div class="wrapper col4">
  <div id="container">
    <h6>Our Address</h6>
    <p>
Ranjit Project , Bengaluru<br />

<strong>tel</strong>:8892700779<br />

<strong>Email ID</strong>: ranjitkumar12034@gmail.com</p>
...
function sendmail($toaddress,$subject,$message)
{
	...
	$mail->Username = 'shivame2011@gmail.com';                 // SMTP username
	$mail->Password = 'welcomebujjima07';                           // SMTP password
	$mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
	$mail->Port = 587;                                    // TCP port to connect to
	
	$mail->From =$tomail ;
	$mail->FromName = 'Web Mall';
	$mail->addAddress($toaddress, 'hi User');     // Add a recipient
	$mail->addAddress($toaddress);               // Name is optional
	$mail->addReplyTo($toaddress, 'Information');
	$mail->addCC('');
	$mail->addBCC('');
