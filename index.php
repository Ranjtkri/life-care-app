...
<html lang="en">
  ...
  <body>
    <nav class="navbar py-4 navbar-expand-lg ftco_navbar navbar-light bg-light flex-row">
	    		...
	    		<div class="col-lg-10 d-none d-md-block">
		    		<div class="row d-flex">
			    		<div class="col-md-4 pr-4 d-flex topper align-items-center">
						    ...
						    <span class="text">Address: Bangalore, Karnataka </span>
					    </div>
					    <div class="col-md pr-4 d-flex topper align-items-center">
					    	<div class="icon bg-white mr-2 d-flex justify-content-center align-items-center"><span class="icon-paper-plane"></span></div>
						    <span class="text">Email: Ranjit@email.com</span>
					    </div>
					    <div class="col-md pr-4 d-flex topper align-items-center">
					    	<div class="icon bg-white mr-2 d-flex justify-content-center align-items-center"><span class="icon-phone2"></span></div>
						    <span class="text">Phone: 9538587572</span>
					    </div>
				    </div>
			    </div>
		    </div>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container d-flex align-items-center">
	      ...
	      <p class="button-custom order-lg-last mb-0"><a href="patientappointment.php" class="btn btn-secondary py-2 px-3">Make An Appointment</a></p>
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	        	...
	        	<li class="nav-item"><a href="patientlogin.php" class="nav-link">Login</a></li>
	        	<li class="nav-item"><a href="patient.php" class="nav-link">Registration</a></li>
    ...
    <!-- END nav -->
    <font color=blue size=7 face=copper>ONLINE HOspital Management System</font>
      ...
      <div class="slider-item" style="background-image:url(images/bg_1.jpg);" data-stellar-background-ratio="0.5">
        ...
        <div class="container">
          ...
          <div class="col-md-6 text ftco-animate">
            ...
            <p><a href="adminlogin.php" class="btn btn-secondary px-4 py-3 mt-3">ADMIN LOGIN PANEL</a>  <a href="doctorlogin.php" class="btn btn-secondary px-4 py-3 mt-3">DOCTOR LOGIN PANEL</a></p>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | PROJECT DEVELOPED <i class="icon-heart" aria-hidden="true"></i> by Ranjit
